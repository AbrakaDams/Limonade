...
<form method="post" class="form-create-event" id="createEvent" onsubmit="return validateForm()">
	...
	<hr>
	<div class="row">
	<?php var_dump($newEvent); ?>
	    <div class="col-xs-6 .col-md-4">
	      	<label for="type-event">Etendue de votre l'événement</label><br>
	      	<input type="radio" name="role" id="private" value="<?php echo $newEvent['role']; ?>">
	        ...
	        <br>
	        <input type="radio" name="role" id="public" value="<?php echo $newEvent['role']; ?>">
	    ...
	    <div class="col-xs-6 .col-md-4">
	      	...
	      	<option value="<?php echo $newEvent['category']; ?>">Repas</option>
	      	<option value="<?php echo $newEvent['category']; ?>">Soirées</option>
	      	<option value="<?php echo $newEvent['category']; ?>">Vacances</option>
	      	<option value="<?php echo $newEvent['category']; ?>">Journées</option>
	      	</select>
	      	<br>
	    </div>
	</div>
	...
	<div class="row">
	    <div class="col-xs-6 .col-md-4">
	        ...
	        <input type="text" name="title" id="title-event" value="<?php echo $newEvent['title']; ?>"><br><br>
	    </div>
	    <div class="col-xs-6 .col-md-4">    
	      	...
	      	<textarea name="description" id="description" rows="3" cols="70"><?php echo $newEvent['description']; ?></textarea>
	    </div>  
	</div>
	<hr>
	<div class="form-group">        
	     ...
	     <textarea name="address" id="address" rows="5" cols="70"><?php echo $newEvent['address']; ?></textarea>
	</div>
	<hr>
	<div class="row">
	    <div class="col-xs-6 .col-md-4">
		    ...
		    <input type="date" name="date_start" value="<?php echo $newEvent['date_start']; ?>">
		    <br>
		    ...
		    <input type="time" name="time_start" value="<?php echo $newEvent['date_start']; ?>">
	    </div>    
	    <div class="col-xs-6 .col-md-4">
	      	...
	      	<input type="date" name="date_end" value="<?php echo $newEvent['date_end']; ?>">
	      	<br>
	      	...
	      	<input type="time" name="time_end" value="<?php echo $newEvent['date_end']; ?>">
	    </div>	
	</div>
	<hr>  
