...
class NewsfeedModel extends \W\Model\Model
{
    public function joinNewsFeed($id){
      ...
      $sql = 'SELECT newsfeed.id_event, newsfeed.id_user, newsfeed.date_news, newsfeed.action, newsfeed.id_card, newsfeed.id_list, list.list_title, cards.card_title, list.id_event, list.date_add, users.username, users.avatar, users.id
      FROM newsfeed
